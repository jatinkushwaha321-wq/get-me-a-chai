...
export default function Home() {
  return (
    <>
      <div className="flex flex-col justify-center items-center h-[44vh] gap-4 text-white px-5 md:px-0 text-xs md:text-base">
        <div className="md:text-5xl text-3xl flex gap-2 justify-center items-center font-bold">Get Me a Chai <span><img className="invertImg" src="/tea.gif" alt="" width={88} /></span> </div>
        <p className='text-center md:text-left'>A crowdfunding platform for creators to fund their projects.
        </p>
        <p className='text-center md:text-left'>A place where your fans can buy you a chai. Unlease the power of your community!
        </p>
        <div>
          <Link href={"/login"}>
      ...
      <div className="container text-white mx-auto pb-32 pt-14 px-10">
